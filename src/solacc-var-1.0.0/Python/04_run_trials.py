...
# TODO
try:
  mlflow.set_experiment("/Users/odl_user_251397@databrickslabs.onmicrosoft.com/solacc-var-1.0.0/Python/04_run_trials")
except:
...
def logTableVersion(tablename:str, v:int):
  try:
    ...
    print(f"{tablename} is not a Delta table")
